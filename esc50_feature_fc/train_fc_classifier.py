...
ESC50_FEATURES_PATH = 'esc50_feature_fc/esc50_features_hubert.pt'
...
features = features_labels['features']  # [N, 768]
...
class LinearClassifier(nn.Module):
    def __init__(self, in_dim=768, num_classes=50):
        super().__init__()
...
class ThreeLayerClassifier(nn.Module):
    def __init__(self, in_dim=768, num_classes=50, hidden_dim=256):
        super().__init__()
